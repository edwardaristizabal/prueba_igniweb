...
Class Autor
{
	...
	{
		$sql="INSERT INTO autor (nombre,descripcion,imagen,estado)
	...
	{
		$sql="UPDATE autor SET estado='0' WHERE idautor='$idautor'";
		return ejecutarConsulta($sql);
	}
	...
	{
		$sql="UPDATE autor SET estado='1' WHERE idautor='$idautor'";
		return ejecutarConsulta($sql);
	}
