...
Class Materia
{
	...
	{
		$sql="INSERT INTO materia (nombre,descripcion,estado)
	...
	{
		$sql="UPDATE materia SET estado='0' WHERE idmateria='$idmateria'";
		return ejecutarConsulta($sql);
	}
	...
	{
		$sql="UPDATE materia SET estado='1' WHERE idmateria='$idmateria'";
		return ejecutarConsulta($sql);
	}
